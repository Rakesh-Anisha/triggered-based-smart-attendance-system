...
// //   useEffect(() => {
// //     // Get registration number from token
...
// //   useEffect(() => {
// //     // Fetch data when regNo is set and appropriate inputs are provided
// //     if (!regNo) return;
...
// //                 <div className="student-progress-circle" style={{ '--percentage': subject.percentage }}>
